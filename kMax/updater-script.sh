...
echo -e "${Cyan}delete the old files ${NC}"
rm de.json en.json fa.json de.yml en.yml fa.yml application.html.erb
#
echo -e"${Green}downloading new file from github ${NC}"
...
#
echo -e "${Green} docker compose up -d  runs ${NC}"
#
docker compose up -d
